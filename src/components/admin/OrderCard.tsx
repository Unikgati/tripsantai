...
export const OrderCard: React.FC<OrderCardProps> = ({ order, onContact, onOpenPaymentModal, onViewDetails, onComplete, onCancel, onGenerateInvoice }) => {
        ...
        <div className="order-card">
            ...
            <div className="order-card-actions">
                ...
                {order.status === 'Menunggu Pembayaran' && (
                    <button className="btn-icon" title="Buat & Bagikan Invoice" onClick={() => onGenerateInvoice && onGenerateInvoice(order)}>
                        <InvoiceLinkIcon />
                    </button>
                )}
                {renderActions()}
