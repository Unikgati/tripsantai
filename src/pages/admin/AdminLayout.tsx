        ...
        <>
            ...
            <div className="admin-layout">
                <aside className={`admin-sidebar ${isSidebarOpen ? 'open' : ''}`}>
                    <div className="logo" role="button" tabIndex={0} onClick={() => { try { setPage && setPage('home'); } catch {} ; navigate('/'); }} onKeyPress={(e) => { if (e.key === 'Enter' || e.key === ' ') { try { setPage && setPage('home'); } catch {} ; navigate('/'); } }}>
                    ...
                    <ul className="admin-nav">
                        ...
                        <li><NavLink to="/admin/orders" className={({isActive}) => isActive ? 'active' : ''}>Pesanan</NavLink></li>
                        <li><NavLink to="/admin/destinations" className={({isActive}) => isActive ? 'active' : ''}>Destinasi</NavLink></li>
                        <li><NavLink to="/admin/blog" className={({isActive}) => isActive ? 'active' : ''}>Blog</NavLink></li>
                        <li><NavLink to="/admin/settings" className={({isActive}) => isActive ? 'active' : ''}>Pengaturan</NavLink></li>
                    </ul>
                    ...
                    <div className="admin-header">
                         ...
                         <div className="admin-header-actions">
                            ...
                            <button
                                ...
                                onClick={toggleTheme}
                                aria-label={appSettings.theme === 'light' ? 'Ganti ke mode gelap' : 'Ganti ke mode terang'}
                              >
